...
def main(args):
    ...
    # model.load_state_dict(torch.load("model/12_epoch_999_lr_0.001_bottom.pt"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--validate_set', type=str, default='pos-5-evl', help='path for validate set')

...
class MyParticleNetwork(torch.nn.Module):
    ...
    def compute_correction(self,
        ...
        fluid_feats = torch.cat(fluid_feats, dim=-1)    # concat as [[1, v_x, v_y, v_z],[..]]
        ...
        feats = torch.cat((self.ans_conv0_obstacle, self.ans_conv0_fluid, self.ans_dense0_fluid), dim=-1)

...
def get_particle_data(file, save_file, num_lines=200):
    ...
    # suitable for training data, but not readable by human
    dataset = []
...
def apic_2d_data_clean(origin_file, save_file):
    ...
    # readable for human with numpy savetxt method
...
def boundary_generation(box_save_file):
    ...
    x = np.arange(20, 80, 0.05)
    y = np.arange(20, 80, 0.05)
...
def boundary_generation_no_wall(box_save_file):
    ...
    # generate the bottom
    bottom_x = np.arange(20., 80.05, 0.05)
    for each in bottom_x:
        box_pos.append([each, 20., -0.05])
        box_normals.append([0., 1., 0.])

        box_pos.append([each, 20., 0.05])
        box_normals.append([0., 1., 0.])

    y = np.arange(20.05, 80.05, 0.05)
    # generate left and right
    for each in y:
        box_pos.append([80., each, -0.05])
        box_normals.append([-1., 0., 0.])
        box_pos.append([80., each, 0.05])
        box_normals.append([-1., 0., 0.])

        box_pos.append([20., each, -0.05])
        box_normals.append([1., 0., 0.])
        box_pos.append([20., each, 0.05])
        box_normals.append([1., 0., 0.])
...
if __name__ == '__main__':
    # with open('../dataset/input_train/fluid_train.pkl', 'rb') as f:
    #     dataset = pickle.load(f)
    # print(dataset[0])
    # boundary_generation_no_wall('../dataset/input_train/box_train.pkl')
    get_particle_data('../dataset/input_train/train_10p_long2.txt', '../dataset/input_train/train_10p_long2.pkl', 200)
    # data_normalization('../dataset/input_train/train1.pkl', '../dataset/input_train/fluid_train.pkl')
    # get_particle_data('../dataset/train/5particle-2.txt', '../dataset/input_train/train2.pkl', 10)
    # add_training_data('../dataset/input_train/train2.pkl', '../dataset/input_train/fluid_train.pkl')
...
def create_raw_data(dir_name):
    output_dir = os.path.join(os.getcwd(), dir_name)
    sceneFile = 'D:/1_Study/1_ClassMaterials\Master1\Research\splishdata/Sampling_2D.json'
...
# create_raw_data('3p_-5_-5')
read_vtk('3p_-5_-5/vtk', 'fluid_train_3p_-5_-5.pkl', 'wb')
